...
$(document).ready(function() {
    ...
    function loadChatHistory(instructorId) {
        $.ajax({
            url: 'Controller/load_chat_parent.php', // This PHP file will be created for loading chat history
            method: 'POST',
    ...
    $('#sendMessage').click(function() {
        ...
        if (selectedInstructorId && message) {
            $.ajax({
                url: 'Controller/send_message_parent.php', // This PHP file sends the message
                method: 'POST',
                data: {
